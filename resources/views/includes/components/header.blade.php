<header x-data="{ scrolled: false }"
    ...
    :class="scrolled ? 'bg-gray-900 py-3' : 'bg-transparent py-6'"
     class="fixed top-0 left-0 right-0 z-10 text-white border-b border-white">
                ...
                <nav>
                    <div class="flex items-center justify-end gap-8">
                        ...
                        <div class="flex items-center justify-center gap-4">
                            <a href="#" class="flex items-center justify-center px-4 py-1 text-base font-medium text-white bg-transparent border-2 border-white rounded-full shadow-sm hover:bg-amber-50 hover:text-amber-500 sm:px-8">Log In</a>
